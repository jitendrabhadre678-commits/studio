    ...
    <main className="min-h-screen bg-black">
      ...
      <div className="pt-32 pb-20 px-4">
        <div className="container mx-auto max-w-5xl">
          ...
          <div className="glass-card rounded-[3rem] border-white/10 shadow-2xl animate-fade-in-up [animation-delay:200ms] overflow-hidden">
            <div className="overflow-x-auto scrollbar-hide">
              <div className="min-w-[800px]">
                ...
                <div className="grid grid-cols-12 p-6 bg-white/5 text-[10px] font-black uppercase tracking-[0.2em] text-white/40 border-b border-white/10">
                  <div className="col-span-2 text-center sticky left-0 bg-[#0a0a0a]/90 backdrop-blur-md z-10">Rank</div>
                  <div className="col-span-6 pl-4">Player Identity</div>
                ...
                <div className="divide-y divide-white/5">
                  {users.map((user, idx) => (
                    <div 
                      key={user.id} 
                      className={cn(
                        "grid grid-cols-12 items-center transition-all duration-500 hover:bg-white/[0.04] group cursor-default",
                        idx === 0 && "bg-yellow-500/[0.03]",
                        idx === 1 && "bg-slate-400/[0.03]",
                        idx === 2 && "bg-amber-700/[0.03]"
                      )}
                    >
                      {/* Rank Display - Sticky on horizontal scroll */}
                      <div className="col-span-2 text-center relative py-6 md:py-8 sticky left-0 z-10 bg-[#0a0a0a]/90 backdrop-blur-md border-r border-white/5">
                        {idx < 3 ? (
                      ...
                      {/* Profile Info */}
                      <div className="col-span-6 flex items-center gap-4 md:gap-6 py-6 md:py-8 pl-8">
                      ...
                      {/* Earning Display */}
                      <div className="col-span-4 text-right py-6 md:py-8 pr-8">
