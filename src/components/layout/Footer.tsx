            ...
            <div className="max-w-sm">
              ...
              <div className="flex gap-4">
                {[
                  ...
                  <Link key={idx} href={social.href} className="w-10 h-10 glass-card rounded-xl flex items-center justify-center text-white/60 hover:text-primary hover:border-primary/50 transition-all">
                    {social.icon}
                  </Link>
                ))}
              </div>
