 ...
 * Features the standardized "Claim Now" premium CTA and trust indicators.
 */
      ...
      <div className="glass-card rounded-2xl transition-all duration-500 bg-[#0a0a0a] shadow-lg hover:shadow-primary/5 hover:border-primary/30 overflow-hidden hover:scale-[1.01] border border-white/10">
        <div className="p-6 md:p-10">
          <div className="flex flex-col lg:flex-row lg:items-center justify-between gap-6 md:gap-8">
            ...
            <div className="w-full lg:w-auto shrink-0 mt-2 lg:mt-0 flex flex-col items-center gap-3">
              <Button 
                onClick={handleClaim}
                className="w-full lg:w-80 h-14 md:h-20 bg-gradient-to-r from-[#009dff] to-[#00e0ff] text-white font-black uppercase tracking-[0.2em] rounded-xl md:rounded-2xl shadow-xl transition-all text-xs md:text-base hover:scale-[1.05] hover:shadow-[0_0_25px_rgba(0,150,255,0.5)] active:scale-[0.97] border-none"
              >
                Claim Now ⚡
              </Button>
              <p className="text-[10px] md:text-xs text-white/60 font-bold uppercase tracking-widest text-center">
        ...
        <div className="hidden lg:block absolute top-1/2 -left-5 -translate-y-1/2 w-10 h-10 bg-[#050b18] rounded-full border border-white/10" />
        <div className="hidden lg:block absolute top-1/2 -right-5 -translate-y-1/2 w-10 h-10 bg-[#050b18] rounded-full border border-white/10" />
      </div>
    </div>
  );
}
